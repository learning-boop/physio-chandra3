...
export const REGION_CHAINS = [
  ...
  ['tlj', 'lowback', 'sij', 'hip', 'thigh', 'knee', 'ankle'],
...
const AREA_WORD = {
  ...
  elbow: 'elbow', forearm: 'forearm', wrist: 'wrist', hand: 'hand or fingers', hip: 'hip', thigh: 'thigh', knee: 'knee', ankle: 'ankle or foot',
}
